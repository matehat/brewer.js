(function() {
  var EventEmitter, Formula, Installer, basename, chdir, coffeescript, crypto, debug, fs, info, join, move, request, resolve, semver, spawn, temp, validVersionSpec, vm, _, _ref, _ref2,
  ...
  Installer = (function(_super) {
    ...
    Installer.prototype.include = function(src, opts, cb) {
      ...
      root = this.project.vendorlibs.root;
  ...
  Formula = (function() {
    ...
    Formula.prototype.valid = function() {
      return (this.urlGetter != null) && (this.installer != null);
    };

    Formula.prototype.url = function(vsn) {
      var match, urlGetter, version, versions;
    ...
    Formula.prototype.context = function() {
      var _this = this;
      return {
        homepage: function(homepageURL) {
          _this.homepageURL = homepageURL;
        },
        doc: function(docURL) {
          _this.docURL = docURL;
        },
        ...
        latest: function(latestVersion) {
          _this.latestVersion = latestVersion;
        },
        ...
        versions: function() {
          ...
          if (_this.availableVersions == null) _this.availableVersions = [];
          return (_ref3 = _this.availableVersions).push.apply(_ref3, versions);
        },
        urls: function(map) {
          var value, version, _results;
          if (_.isFunction(map)) {
            return _this.urlGetter = map;
            ...
            for (version in map) {
              ...
              if (!(_this.urlGetter != null) || _.isFunction(_this.urlGetter)) {
                _this.urlGetter = {};
              }
              _results.push(_this.urlGetter[version] = value);
            }
            return _results;
          }
        },
