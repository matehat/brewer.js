(function() {
  var Catalog, EventEmitter, Formula, Installer, InvalidChecksum, NonSemanticVersion, basename, chdir, coffeescript, crypto, debug, fs, info, join, move, request, resolve, semver, spawn, temp, validVersionSpec, vm, _, _ref, _ref2,
