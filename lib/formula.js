(function() {
  var EventEmitter, Formula, Installer, InvalidChecksum, basename, chdir, coffeescript, crypto, debug, fs, info, join, move, request, resolve, semver, spawn, temp, validVersionSpec, vm, _, _ref, _ref2,
