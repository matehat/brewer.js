(function() {
  var EventEmitter, File, debug, finished, fs, info, path, util, _, _ref,
  ...
  _ref = require('./command'), finished = _ref.finished, debug = _ref.debug, info = _ref.info;
    ...
    File.prototype.watch = function(reset) {
      ...
      if (this.attached() && this.liabilities.length > 0) {
        ...
        this.watcher = fs.watch(this.fullpath, function(event) {
          ...
          if (event === 'rename') {
            info("" + _this.fullpath + " removed");
            _ref2 = _this.liabilities;
            for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
              file = _ref2[_i];
              file.destroy();
            }
