(function() {
  ...
  File = (function(_super) {
    ...
    File.prototype.dependOn = function(other, actualize) {
      return this.dependencies.push([other, actualize]);
    };
    ...
    File.prototype.actualize = function(cb) {
      ...
      return (iter = function(cb2) {
        ...
        var act, dep, _i, _len, _ref2, _ref3, _results;
    ...
    File.prototype.readImportedPaths = function() {
      ...
      if ((json = recurse(this.readSync())).length > 0) {
    ...
    File.prototype.setImportedPaths = function(paths) {
      return this._importedPaths = paths;
    };
    ...
    File.prototype.imports = function() {
      ...
      if (this._imports == null) {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          path = _ref2[_i];
          this._imports = this.package.file(path, this.type);
        }
      }
    ...
    File.prototype.tsortedImports = function() {
      var DAG, S, buildDAG, edges, m, n, topoSortedFiles, visited, _i, _len, _ref2;
      topoSortedFiles = [];
      DAG = {};
      visited = [];
      ...
      while (S.length > 0) {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          ...
          if (edges.length === 0) S.push(m);
        }
      }
      return topoSortedFiles.reverse();
    };

    File.prototype.newest = function() {
      var other;
      return util.newestSync.apply(util, [this.fullpath].concat(__slice.call((function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.dependencies;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          other = _ref2[_i];
          _results.push(other.fullpath);
        }
        return _results;
      }).call(this))));
    };
    ...
    File.prototype.valid = function() {
      ...
      if (!_.all(this.dependencies, function(dep) {
        return dep.valid();
      })) {
        return false;
      }
      if (!this.newest()) return false;
    };
    ...
    File.prototype.read = function(cb) {
      ...
      return fs.readFile(this.fullpath, 'utf-8', cb);
    };
    ...
    File.prototype.transformInto = function(dest, morph, cb) {
      return this.read(function(err, data) {
        if (err) cb(err);
        return morph(data, function(newdata) {
