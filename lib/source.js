(function() {
  ...
  Source = (function() {
    ...
    function Source(options, package) {
      ...
      _ref = this.options, this.watch = _ref.watch, this.path = _ref.path, this.follow = _ref.follow, this.requirements = _ref.requirements;
    ...
    Source.prototype.files = function(yield, end) {
      ...
      if (this.filelist != null) {
        ...
        this.filelist = [];
        each = function(fpath) {
          var file, imports, _ref;
          file = _this.createFile(util.changeext(fpath, ''));
          if ((imports = (_ref = _this.requirements) != null ? _ref[file.relpath] : void 0) != null) {
