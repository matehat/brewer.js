(function() {
  ...
  Source = (function() {
    ...
    Source.prototype.createFile = function(path) {
      var ctor, file;
      ctor = this.constructor;
      file = new File(path, path.join(this.path, path), ctor.types[0], this);
      this.package.registerFile(file);
      return file;
    };
