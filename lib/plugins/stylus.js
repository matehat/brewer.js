(function() {
  var Bundle, Source, StylesheetsBrewer, StylesheetsBundle, StylesheetsSource, StylusBundle, StylusSource, debug, finished, fs, path, util, _, _ref, _ref2,
  ...
  this.StylusBundle = StylusBundle = (function(_super) {
    ...
    StylusBundle.prototype.setOptions = function(styl) {
      var mod, mods, module, opts, _i, _len;
      styl.set('paths', this.importPaths());
      styl.set('filename', this.file);
      opts = this.brewer.source(this.file).options;
      if ((mods = opts.modules) != null) {
        if (_.isString(mods)) mods = [mods];
