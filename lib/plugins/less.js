(function() {
  var Bundle, LessSource, Source, StylesheetsPackage, StylesheetsSource, debug, finished, fs, path, util, _ref, _ref2,
  ...
  LessSource = (function(_super) {
    ...
    LessSource.prototype.createCompiledFile = function(original) {
      ...
      compiled = new File(path, path.join(this.output, cpath), 'stylesheets', this);
