(function() {
  var LessSource, Source, StylesheetsPackage, StylesheetsSource, debug, finished, fs, path, temp, util, _ref, _ref2,
  ...
  LessSource = (function(_super) {
    ...
    LessSource.prototype.createCompiledFile = function(original) {
      var compiled, cpath, opath, _ref3;
      cpath = util.changeext((opath = original.relpath), '.css');
      compiled = this.package.file(opath, 'stylesheets', path.join((_ref3 = this.output) != null ? _ref3 : "./cache", cpath), this);
