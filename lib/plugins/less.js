(function() {
  var Bundle, LessBundle, LessSource, Source, StylesheetsBundle, StylesheetsPackage, StylesheetsSource, debug, finished, fs, path, util, _ref, _ref2,
  ...
  this.LessBundle = LessBundle = (function(_super) {
    ...
    function LessBundle(package, file) {
      this.package = package;
      this.file = file;
      LessBundle.__super__.constructor.call(this, this.package, this.file);
    }
  ...
  this.LessSource = LessSource = (function(_super) {
    ...
    LessSource.prototype.compileFile = function(relpath, next) {
      return (new LessBundle(this.package, relpath)).bundle(function() {
        return next();
      });
    };
