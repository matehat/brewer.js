(function() {
  ...
  exports.run = function(argv) {
    ...
    program.command('clean [packages]*').description(" Delete bundles and compiled files from the given packages (or all)").action(function(pkgs) {
      var names, packages, pkg, project, _i, _len, _results;
      if (pkgs == null) pkgs = 'all';
      project = getLocalProject();
      if (pkgs === 'all') {
    ...
    program.command('install').description(" Install missing modules required to manage the current project").action(function() {
      var project;
      project = getLocalProject();
