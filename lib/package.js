(function() {
  ...
  Package = (function(_super) {
    ...
    Package.prototype.requiredModules = function() {
      return _.chain(this.sources).values().flatten().invoke('requiredModules').flatten().uniq().value();
    };
