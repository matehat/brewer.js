(function() {
  ...
  this.Package = Package = (function() {
    ...
    Package.create = function(options) {
      var typ;
    ...
    Package.prototype.bundle = function(relpath) {
    ...
    Package.prototype.package = function(relpath, cb) {
    ...
    Package.prototype.packageAll = function(cb) {
      var _this = this;
      return this.compileAll(function() {
        var cnt;
        cnt = _this.bundles.length;
